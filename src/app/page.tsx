      ...
      <main className="mt-20 flex h-full flex-col items-center gap-16">
        ...
        <section id="start" className="space-y-8">
          <h1 className="text-center text-5xl font-bold tracking-tight">
            The ultimate <span className="text-primary">shopping</span>{" "}
            management
          </h1>
        ...
        <section id="getting-started" className="w-full px-6 py-4">
          <ul className="space-y-20">
            <li className="space-y-1">
              ...
              <p className="text-sm">
                You can use your Google or Github account to make the process
                more seamless.
              </p>
            </li>
            <li className="space-y-1">
        ...
        <section id="details" className="w-full bg-muted px-4 py-12">
          <p className="text-center">
            Cartapp is a fully web based application that enchance your
            experience and efficeny when buying groceries. Find below just few
            of many features that makes Cartapp an amazing app:
          </p>
          ...
          <ul className="space-y-16">
            <li>
              <blockquote className="border-l-2 pl-6 italic">
                I have no idea there is soo much to improve until i tried
                Cartapp. After 6 months of using it i cant even imagine how i
                was managing my groceries before!
              </blockquote>
            ...
            <li>
              <blockquote className="mt-6 border-l-2 pl-6 italic">
                I can&apos;t endorse Cartapp enough. It not only helped me with
                my spendings, but also my friends and family to whom i
                recomended it.
              </blockquote>
              <div className="mt-3 flex items-center gap-1.5 pl-2">
                <Avatar>
